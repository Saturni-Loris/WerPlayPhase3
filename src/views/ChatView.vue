<template>
  <div class="container">
    <h1 class="text-dark p-8 text-3xl font-bold">
      ...
      <span class="text-orangewerplay">chat ici</span>
    </h1>
      ...
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text text-white bg-orangewerplay"
            >Avec qui voulez-vous parler?</span
          >
        </div>
        <select
          class="custom-select"
      ...
      <div v-if="userSelected != null">
        <form class="mb-3" @submit.prevent="createDisc()">
          <div class="input-group">
            <div class="input-group-prepend">
              <span class="input-group-text text-white bg-orangewerplay"
                >Nom du nouveau fil avec {{ userSelected.login }}</span
              >
            </div>
            <input
              type="text"
            ...
            />
            <button
              class="btn btn-light border-2 border-orangewerplay"
              type="submit"
              title="Création"
            >
            ...
            <tbody>
              <tr v-for="disc in chat" :key="disc.uid">
                <div>
                  ...
                  <div
                    class="rounded-2xl border-2 border-orangewerplay"
                    @click="viewFil(disc)"
                  >
                    <div class="m-2 flex items-center justify-center">
                      <h1 class="font-bold">Voir le chat</h1>
                      <button>
                        <i class="fa fa-eye fa-lg px-2"></i>
                      </button>
                    </div>
                  </div>
                </div>
