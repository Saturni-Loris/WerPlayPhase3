        ...
        <tbody>
          <tr>
            <td class="text-center">
              <img
                class="imageSmall"
                src="https://jsonvideo.jmfino.fr/imagespersonnes/J.J.Abrams.jpg"
                alt="Jeffrey Abrams"
              />
            </td>
            <td><b>Abrams</b></td>
            ...
            <td>27/06/1966</td>
            <td>
              <span title="Supprimer le participant">
                <a href="#">
                  <i class="fa fa-times fa-lg text-light"></i>
                </a>
              </span>
              <span title="Modifier le participant">
                <a href="#">
          ...
          <tr>
            <td class="text-center">
              <img
                class="imageSmall"
                src="https://jsonvideo.jmfino.fr/imagespersonnes/AmyAdams.jpg"
                alt="Amy Adams"
              />
            </td>
            <td><b>Adams</b></td>
