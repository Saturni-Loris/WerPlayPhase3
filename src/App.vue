...
<template>
  ...
  <footer class="text-center lg:text-left bg-orangewerplay text-white">
  <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
    <div class="mr-12 hidden lg:block">
      <span>Get connected with us on social networks:</span>
    </div>
    <div class="flex justify-center">
      <a href="https://www.facebook.com/WerPlayPport/" class="mr-6 text-gray-600">
      ...
      <a href="https://www.twitter.com/werplay_fr/" class="mr-6 text-gray-600">
      ...
      <a href="https://www.instagram.com/werplaysport/" class="mr-6 text-gray-600">
    ...
    <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="">
        ...
        <p class="flex items-center justify-center md:justify-start mb-4">
          ...
          <a href="https://goo.gl/maps/NREXqYxHei6pWvAu9">4 Place Tharradin, 25200 Montbéliard</a>
        </p> 
        <p class="flex items-center justify-center md:justify-start mb-4">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope"
            ...
            <a href="mailto:werplay.contact@gmail.com">werplay.contact@gmail.com</a>
        </p>
